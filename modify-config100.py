...
for switch in list_of_switches:
    ...
    try:
        ...
        # Dynamically determine device type
        device_type = connect_to_device.device_type
        logging.info(f"Connected to {switch} with device type: {device_type}")
